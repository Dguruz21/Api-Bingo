...
describe("BingoController", () => {
   describe("checkWinner", () => {
      test("test check winner", async () => {
         ...
         const payload = fs.readFileSync(path.resolve(__dirname, "../mocks/requests/mockCheckBingoWinner.json"), "utf-8");
         ...
         const result = await bingoController.checkBingoWinner(apiProxyEvent);
